...
const ContactList = (props: Props) => {
  ...
  return (
    <>
      <div className={styles.contactList} ref={listRef}>
        {mapContacts()}
        {isLoading && <p className={styles.warningText}>Loading...</p>}
        {!isLoading && !contacts.length && <p className={styles.warningText}>No results found.</p>}
      </div>
      <Modal
